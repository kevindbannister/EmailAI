    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-6 py-12 dark:bg-slate-950">
      <Card className="w-full max-w-md space-y-4 text-center">
        ...
        <div className="space-y-3 text-left">
          <input value={email} onChange={(e) => setEmail(e.target.value)} className="mt-2 w-full rounded-xl border px-3 py-2 text-sm" type="email" placeholder="Email" />
          <input value={password} onChange={(e) => setPassword(e.target.value)} className="mt-2 w-full rounded-xl border px-3 py-2 text-sm" type="password" placeholder="Password" />
